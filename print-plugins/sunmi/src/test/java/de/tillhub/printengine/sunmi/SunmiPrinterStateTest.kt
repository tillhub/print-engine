...
internal class SunmiPrinterStateTest : FunSpec({
    ...
    test("convert") {
        ...
        SunmiPrinterState.convert(
            SunmiPrinterState.AbnormalCommunication
        ) shouldBe PrinterState.Error.AbnormalCommunication
        SunmiPrinterState.convert(
            SunmiPrinterState.OutOfPaper
        ) shouldBe PrinterState.Error.OutOfPaper
        SunmiPrinterState.convert(
            SunmiPrinterState.Overheated
        ) shouldBe PrinterState.Error.Overheated
        SunmiPrinterState.convert(
            SunmiPrinterState.CoverNotClosed
        ) shouldBe PrinterState.Error.CoverNotClosed
        SunmiPrinterState.convert(
            SunmiPrinterState.PaperCutterAbnormal
        ) shouldBe PrinterState.Error.PaperCutterAbnormal
        SunmiPrinterState.convert(
            SunmiPrinterState.PaperCutterRecovered
        ) shouldBe PrinterState.Connected
        SunmiPrinterState.convert(
            SunmiPrinterState.BlackMarkNotFound
        ) shouldBe PrinterState.Error.BlackMarkNotFound
        SunmiPrinterState.convert(
            SunmiPrinterState.NotDetected
        ) shouldBe PrinterState.Error.NotAvailable
        SunmiPrinterState.convert(
            SunmiPrinterState.FirmwareUpgradeFailed
        ) shouldBe PrinterState.Error.FirmwareUpgradeFailed
    }
})
